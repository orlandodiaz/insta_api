...
class TestInstaAPI:
  ...
  def test_get_user_info(self, insta):
    """ Test if user information retrieval is working fine"""

    data = insta.get_user_info('insta_api_tester')
    assert data

  # def test_upload_photo(self, insta):
  #   path = os.path.join(self.my_path, "resources/mountain.jpg")
  #
  #   insta.post_photo(path, 'no caption')
  #
  ...
  #   path = os.path.join(self.my_path, "resources/mountain.jpg")
  #
  #   insta.post_photo(path, 'Delete me')
  ...
  #   path = os.path.join(self.my_path, "resources/mountain.jpg")
  #   insta.post_photo(path, 'Delete me 2')
  #   media_id = insta.last_resp.json()['media']['pk']
  #   print(media_id)
